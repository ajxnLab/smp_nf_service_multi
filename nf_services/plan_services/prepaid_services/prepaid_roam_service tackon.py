...
class PrepaidRoamService:
    ...
    def _process_check_has_subscription(self, service_id, bs_row_data):
        tackon_value = bs_row_data[nf.BS_INDEX_TACKON]
        if tackon_value.lower() == "yes":
            logger.info("Tack-On is enabled, processing Check Has Subscription step.")
